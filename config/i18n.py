...
LANG: Dict[str, Dict[str, str]] = {
    "ru": {
        ...
        "problem_dns_timeout": "Таймаут DNS",
        "problem_mtu": "Проблема MTU",
        "problem_high_latency": "Высокая задержка",
        "problem_high_jitter": "Высокий джиттер",
        "problem_packet_loss": "Потери пакетов",
        "problem_route_change": "Изменение маршрута",
        "problem_route_degradation": "Деградация маршрута",
        "problem_hop_timeout": "Таймаут хопа",
        "problem_intermittent": "Прерывистая связь",
        "problem_cascading": "Каскадная проблема",
        "problem_connection_lost": "Потеря соединения",
        ...
        "avg_short": "Средний",
        "ui_update": "\u043e\u0431\u043d\u043e\u0432\u043b\u0435\u043d\u0438\u0435",
        "ui_live_target": "\u0426\u0435\u043b\u044c",
        "ui_local_time": "\u041b\u043e\u043a\u0430\u043b\u044c\u043d\u043e\u0435 \u0432\u0440\u0435\u043c\u044f",
        "ui_signal_none": "\u043d\u0435\u0442 \u0441\u0438\u0433\u043d\u0430\u043b\u0430",
        "ui_live": "\u043e\u043d\u043b\u0430\u0439\u043d",
        "ui_live_latency": "\u0422\u0435\u043a\u0443\u0449\u0430\u044f \u0437\u0430\u0434\u0435\u0440\u0436\u043a\u0430",
        "ui_stability": "\u0421\u0442\u0430\u0431\u0438\u043b\u044c\u043d\u043e\u0441\u0442\u044c",
        "ui_history": "\u0418\u0441\u0442\u043e\u0440\u0438\u044f",
        "ui_trend": "\u0422\u0440\u0435\u043d\u0434",
        "ui_jitter_trail": "\u0418\u0441\u0442\u043e\u0440\u0438\u044f \u0434\u0436\u0438\u0442\u0442\u0435\u0440\u0430",
        "ui_type": "\u0422\u0438\u043f",
        "ui_ok_short": "OK",
        "ui_bar": "\u0428\u043a\u0430\u043b\u0430",
        "ui_value": "\u0417\u043d\u0430\u0447\u0435\u043d\u0438\u0435",
    ...
    "en": {
        ...
        "problem_dns_timeout": "DNS Timeout",
        "problem_mtu": "MTU Issue",
        "problem_high_latency": "High Latency",
        "problem_high_jitter": "High Jitter",
        "problem_packet_loss": "Packet Loss",
        "problem_route_change": "Route Change",
        "problem_route_degradation": "Route Degradation",
        "problem_hop_timeout": "Hop Timeout",
        "problem_intermittent": "Intermittent Connection",
        "problem_cascading": "Cascading Issue",
        "problem_connection_lost": "Connection Lost",
        ...
        "avg_short": "Average",
        "ui_update": "update",
        "ui_live_target": "Live target",
        "ui_local_time": "Local time",
        "ui_signal_none": "no signal",
        "ui_live": "live",
        "ui_live_latency": "Live latency",
        "ui_stability": "Stability",
        "ui_history": "History",
        "ui_trend": "Trend",
        "ui_jitter_trail": "Jitter trail",
        "ui_type": "Type",
        "ui_ok_short": "OK",
        "ui_bar": "Bar",
        "ui_value": "Value",
